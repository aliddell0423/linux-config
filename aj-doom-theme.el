;;; aj-doom-theme.el --- Description -*- lexical-binding: t; -*-
;;
;; Copyright (C) 2021 Andrew Liddell
;;
;; Author: Andrew Liddell <https://github.com/andrew>
;; Maintainer: Andrew Liddell <mreggsaladsandvitch@gmail.com>
;; Created: October 06, 2021
;; Modified: October 06, 2021
;; Version: 0.0.1
;; Keywords: Symbol’s value as variable is void: finder-known-keywords
;; Homepage: https://github.com/andrew/aj-doom-theme
...
(provide 'aj-doom-theme)
;;; aj-doom-theme.el ends here
...
(def-doom-theme doom-sourcerer
  ...
  ((bg         '("#000000"))
   ...
   (selection      base5)
   (builtin        blue)
   (comments       (if doom-sourcerer-brighter-comments dark-cyan red))
   (doc-comments   (if doom-sourcerer-brighter-comments (doom-lighten red 0.15) (doom-darken red 0.1)))
   (constants      teal)
   (functions      base8)
   (keywords       blue)
   (methods        magenta)
   ...
   (modeline-fg     "#bbc2cf")
   (modeline-fg-alt (doom-blend blue red (if doom-sourcerer-brighter-modeline 0.4 0.08)))
