 ...
 */
static const char *fonts[]     = {"Mononoki Nerd Font:size=14:4a4n4tialias=true:autohint=true",
...
static const char col_3[]  = "#FAB200";
static const char col_4[]  = "#2b2a24"; /* border color focused windows and tags */
/* bar opacity
...
static const char *dmenucmd[]    = { "dmenu_run", "-p", "-c", "-bw", "2", "-l", "20", "-g", "4" "Run: ", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,               -1,        XK_f,      spawn,          CMD("st -e vifm") },
	...
	{ MODKEY|ShiftMask,     -1,        XK_m,      spawn,          CMD("st -e mocp") },
	...
	{ MODKEY|Mod1Mask,      XK_g,      XK_s,      spawn,          CMD("/home/andrew/.scripts/get-scripts") },
	{ MODKEY|Mod1Mask,      XK_e,      XK_s,      spawn,          CMD("/home/andrew/.scripts/edit-scripts") },
